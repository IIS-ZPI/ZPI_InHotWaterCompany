...
public class Controller implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        stateList.add(new State("Alabama", 4, new Category(4, 4, 0, 4, 4, 4)));
        stateList.add(new State("Alaska", 0, new Category(0, 0, 0, 0, 0, 0)));
        stateList.add(new State("Arizona", 5.6, new Category(0, 5.6, 0, 5.6, 5.6, 5.6)));
        stateList.add(new State("Arkansas", 6.5, new Category(0.125, 6.5, 0, 6.5, 6.5, 0)));
        stateList.add(new State("California", 7.25, new Category(0, 7.25, 0, 7.25, 7.25, 0)));
        stateList.add(new State("Colorado", 2.9, new Category(0, 2.9, 0, 2.9, 2.9, 2.9)));
        stateList.add(new State("Connecticut", 6.35, new Category(0, 6.35, 0, 0, 6.35, 1)));
        stateList.add(new State("Delaware", 0, new Category(0, 0, 0, 0, 0, 0)));
